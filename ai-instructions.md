# AI Instructions
This file mirrors CLAUDE.md (the file Claude Code auto-loads). Keep both in sync.
...
Whenever this file is updated, also update `CLAUDE.md` at the project root to mirror the content.
